...
func SetupUserRoutes(app *fiber.App, userHander handler.UserHandler) {
	...
	userRoutes.Post("/register", userHander.HandlerCreateUser())
	...
	// @Failure 400 {object} fiber.Map
	// @Router /users/{id} [put]
	userRoutes.Put("/:id", userHander.HandlerUpdateUser())
	...
	// @Failure 400 {object} fiber.Map
	// @Router /users/{id} [get]
	userRoutes.Get("/:id", userHander.HandlerFindUserByID())
	...
	userRoutes.Get("/", userHander.HandlerFindAllUser())
	...
	userRoutes.Delete("/:id", userHander.HandlerDeleteUser())
}
